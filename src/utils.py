...
def data_prep(df, dist_thresh, tar_feats, tar_class):
...
def class_balance(data, sampling_method):
    ...
    # 2.0 Random undersampling
        ...
        rock_idx = list(np.random.choice(data[data['class'] == 'Rock'].index, size=other_size, replace=sample_replacement))
        rubble_idx = list(np.random.choice(data[data['class'] == 'Rubble'].index, size=other_size, replace=sample_replacement))
        sand_idx = list(np.random.choice(data[data['class'] == 'Sand'].index, size=other_size, replace=sample_replacement))
        seagrass_idx = list(np.random.choice(data[data['class'] == 'Seagrass'].index, size=other_size, replace=sample_replacement))
        coral_idx = list(np.random.choice(data[data[tar_class] == 1].index, size=coral_size, replace=sample_replacement))
